...
It happes because of the libtiff update. It bumped up @libtiff.3.dylib@ to @libdiff.5.dylib@. But @rmagick@ still relies on version 3. And it was not updated since Aprill 5, 2010 What a mess...
